...
function SelectNearbyHomestays() {
  ...
  const defaultOptions = useMemo(() => {
    const selected = new Set(form.getValues("nearby_homestay") ?? []);
  ...
  return (
    <FormField
      ...
      name="nearby_homestay"
      render={({ field }) => (
        <FormItem>
          <FormLabel>Nearby Homestays</FormLabel>
          <FormControl>
            {isPending ? (
...
export default SelectNearbyHomestays;
