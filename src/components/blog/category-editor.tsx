...
import { BlogCategory, blogCategorySchema } from "./zod-schema";
...
function CategoryEditor({ initialData, edit }: Props) {
  ...
  async function handleSubmit(data: BlogCategory) {
    try {
      await axios.post(edit ? "/api/blog/category/update" : "/api/blog/category/add", data);
      await queryClient.invalidateQueries({
        queryKey: ["blog-categories"],
      });
      !edit && router.push("/admin/blog/categories");
